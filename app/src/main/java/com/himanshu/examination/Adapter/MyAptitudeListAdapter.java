...
public class MyAptitudeListAdapter extends RecyclerView.Adapter<MyAptitudeListAdapter.ViewHolder> {
    private MyListData[] listData;

    private String subject;
    private String category = "Aptitude Questions";

    // RecyclerView recyclerView;
    public MyAptitudeListAdapter(MyListData[] myListData) {
