...
public class MyVerbalListAdapter extends RecyclerView.Adapter<MyVerbalListAdapter.ViewHolder> {
    private MyListData[] listData;

    String subject;
    String category = "Verbal Questions";

    // RecyclerView recyclerView;
    public MyVerbalListAdapter(MyListData[] myListData) {
